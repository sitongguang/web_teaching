...
@WebServlet("/jwt_login")
public class LoginJwtController extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if(loggedUser!=null){
                 ...
                 *
                 */
                String jws = JwtUtil.createJWT(username, nickname, ttlMillis);
...
//                session.setAttribute("user" , loggedUser);
                response.getWriter().println(JSON.toJSONString(jws));
                return;
            }else{
